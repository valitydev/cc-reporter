...
public class StrictWordSimilarity extends AbstractRoutine<Float> {
    ...
    public StrictWordSimilarity() {
        super("strict_word_similarity", Ccr.CCR, SQLDataType.REAL);
     ...
     */
    public StrictWordSimilarity set__1(String value) {
        setValue(_1, value);
        return this;
    }
     ...
     */
    public StrictWordSimilarity set__2(String value) {
        setValue(_2, value);
        return this;
    }
