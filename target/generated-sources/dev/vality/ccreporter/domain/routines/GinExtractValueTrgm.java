...
public class GinExtractValueTrgm extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>ccr.gin_extract_value_trgm._1</code>.
     */
    ...
    public GinExtractValueTrgm() {
        super("gin_extract_value_trgm", Ccr.CCR, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
     ...
     */
    public GinExtractValueTrgm set__1(String value) {
        setValue(_1, value);
        return this;
    }
     ...
     */
    public GinExtractValueTrgm set__2(Object value) {
        setValue(_2, value);
        return this;
    }
