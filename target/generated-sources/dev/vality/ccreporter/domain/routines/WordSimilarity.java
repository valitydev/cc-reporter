...
public class WordSimilarity extends AbstractRoutine<Float> {
    ...
    public WordSimilarity() {
        super("word_similarity", Ccr.CCR, SQLDataType.REAL);
     ...
     */
    public WordSimilarity set__1(String value) {
        setValue(_1, value);
        return this;
    }
     ...
     */
    public WordSimilarity set__2(String value) {
        setValue(_2, value);
        return this;
    }
